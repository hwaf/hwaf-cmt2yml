...
// is_user_file checks whether a file is hand-written
func is_user_file(fname string) bool {
	...
	auto_gen := bytes.HasPrefix(buf, []byte(`## automatically generated by cmt2yml`)) ||
		bytes.HasPrefix(buf, []byte(`## -*- python -*-
